...
CREATE TABLE `starter` (
  ...
  `tex` varchar(555) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dat` date NOT NULL,
  `categ` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`revid`)
...
INSERT INTO `starter` VALUES (1,4,'Paul','I love your recipe','2021-05-15','1'),(2,4,'Petros','I love your recipe','2021-05-15','1');
